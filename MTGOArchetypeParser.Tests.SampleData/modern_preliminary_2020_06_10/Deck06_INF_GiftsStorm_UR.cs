...
{
    public class Deck06_INF_GiftsStorm_UR : ISampleDeck
    {
        ...
        public (int Count, string Name)[] Sideboard { get { return new (int Count, string Name)[] { (2, "Abrade"),(2, "Aria of Flame"),(3, "Empty the Warrens"),(3, "Lightning Bolt"),(2, "Mystical Dispute"),(2, "Pieces of the Puzzle"),(1, "Shenanigans") }; } }
    }
}