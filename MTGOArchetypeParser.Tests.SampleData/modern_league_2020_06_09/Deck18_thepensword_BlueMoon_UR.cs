...
namespace MTGOArchetypeParser.Tests.SampleData.modern_league_2020_06_09
{
    public class Deck18_thepensword_BlueMoon_UR : ISampleDeck
    {
        ...
        public (int Count, string Name)[] Sideboard { get { return new (int Count, string Name)[] { (2, "Abrade"),(2, "Aether Gust"),(1, "Ashiok, Dream Render"),(1, "Beacon Bolt"),(2, "Blood Moon"),(3, "Ceremonious Rejection"),(1, "Flusterstorm"),(2, "Relic of Progenitus"),(1, "Spell Snare") }; } }
    }
}