...
{
    public class Deck54_DoomedNecromancer_AbzanBlade_WBG : ISampleDeck
    {
        ...
        public (int Count, string Name)[] Sideboard { get { return new (int Count, string Name)[] { (2, "Choke"),(1, "Damnation"),(2, "Eidolon of Rhetoric"),(1, "Elspeth, Sun's Champion"),(1, "Fracturing Gust"),(2, "Gaddock Teeg"),(2, "Kor Firewalker"),(2, "Rest in Peace"),(2, "Stony Silence") }; } }
    }
}