...
{
    public class Deck05_PeanutBrittle_ThopterUrza_UBR : ISampleDeck
    {
        ...
        public (int Count, string Name)[] Sideboard { get { return new (int Count, string Name)[] { (1, "Metallic Rebuke"),(2, "Aether Gust"),(1, "Ashiok, Nightmare Muse"),(1, "Cryptic Command"),(2, "Dead of Winter"),(1, "Disdainful Stroke"),(1, "Dreadbore"),(1, "Drown in the Loch"),(1, "Fatal Push"),(1, "Grafdigger's Cage"),(1, "Sorcerous Spyglass"),(2, "Tezzeret, Agent of Bolas") }; } }
    }
}