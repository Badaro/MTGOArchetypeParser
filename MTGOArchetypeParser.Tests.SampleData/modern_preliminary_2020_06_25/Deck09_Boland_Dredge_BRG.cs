...
namespace MTGOArchetypeParser.Tests.SampleData.modern_preliminary_2020_06_25
{
    public class Deck09_Boland_Dredge_BRG : ISampleDeck
    {
        ...
        public (int Count, string Name)[] Sideboard { get { return new (int Count, string Name)[] { (2, "Ancient Grudge"),(1, "Darkblast"),(2, "Gemstone Caverns"),(4, "Leyline of the Void"),(2, "Lightning Axe"),(3, "Nature's Claim"),(1, "Shenanigans") }; } }
    }
}