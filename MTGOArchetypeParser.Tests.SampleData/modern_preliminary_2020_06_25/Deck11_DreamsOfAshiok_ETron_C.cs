...
{
    public class Deck11_DreamsOfAshiok_ETron_C : ISampleDeck
    {
        ...
        public (int Count, string Name)[] Sideboard { get { return new (int Count, string Name)[] { (1, "Walking Ballista"),(1, "All Is Dust"),(1, "Ensnaring Bridge"),(1, "Grafdigger's Cage"),(1, "Kozilek, the Great Distortion"),(1, "Liquimetal Coating"),(1, "Ratchet Bomb"),(2, "Relic of Progenitus"),(1, "Skysovereign, Consul Flagship"),(1, "Sorcerous Spyglass"),(1, "Sparkhunter Masticore"),(1, "Tormod's Crypt"),(1, "Torpor Orb"),(1, "Wurmcoil Engine") }; } }
    }
}