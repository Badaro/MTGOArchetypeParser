...
{
    public class Deck26_ContraEgo_ThopterUrza_UBR : ISampleDeck
    {
        ...
        public (int Count, string Name)[] Sideboard { get { return new (int Count, string Name)[] { (1, "Metallic Rebuke"),(2, "Aether Gust"),(1, "Ashiok, Nightmare Muse"),(1, "Cryptic Command"),(2, "Dead of Winter"),(1, "Disdainful Stroke"),(1, "Dreadbore"),(1, "Drown in the Loch"),(1, "Fatal Push"),(1, "Grafdigger's Cage"),(1, "Herald of Anguish"),(1, "Sorcerous Spyglass"),(1, "Tezzeret, Agent of Bolas") }; } }
    }
}