...
{
    public class Deck28_PeanutBrittle_GiftsStorm_UR : ISampleDeck
    {
        ...
        public (int Count, string Name)[] Sideboard { get { return new (int Count, string Name)[] { (2, "Abrade"),(1, "Aria of Flame"),(1, "Echoing Truth"),(3, "Empty the Warrens"),(3, "Lightning Bolt"),(2, "Mystical Dispute"),(2, "Pieces of the Puzzle"),(1, "Shenanigans") }; } }
    }
}