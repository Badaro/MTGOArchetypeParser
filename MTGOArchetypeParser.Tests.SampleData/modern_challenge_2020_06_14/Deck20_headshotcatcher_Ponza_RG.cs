...
{
    public class Deck20_headshotcatcher_Ponza_RG : ISampleDeck
    {
        ...
        public (int Count, string Name)[] Sideboard { get { return new (int Count, string Name)[] { (2, "Anger of the Gods"),(1, "Boil"),(1, "Choke"),(2, "Cindervines"),(2, "Collector Ouphe"),(1, "Grafdigger's Cage"),(2, "Kitchen Finks"),(2, "Obstinate Baloth"),(2, "Wheel of Sun and Moon") }; } }
    }
}