...
namespace MTGOArchetypeParser.Tests.SampleData.modern_challenge_2020_06_14
{
    public class Deck30_MathGod_GiftsStorm_UR : ISampleDeck
    {
        ...
        public (int Count, string Name)[] Sideboard { get { return new (int Count, string Name)[] { (1, "Abrade"),(2, "Aria of Flame"),(1, "Dismember"),(2, "Empty the Warrens"),(1, "Flusterstorm"),(3, "Lightning Bolt"),(2, "Mystical Dispute"),(2, "Pieces of the Puzzle"),(1, "Shenanigans") }; } }
    }
}