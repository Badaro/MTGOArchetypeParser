...
namespace MTGOArchetypeParser.Tests.SampleData.modern_challenge_2020_06_14
{
    public class Deck06_MadMaxErnst_Uroza_URG : ISampleDeck
    {
        ...
        public (int Count, string Name)[] Sideboard { get { return new (int Count, string Name)[] { (3, "Aether Gust"),(1, "Ashiok, Dream Render"),(1, "Ceremonious Rejection"),(2, "Damping Sphere"),(1, "Disdainful Stroke"),(1, "Dispel"),(1, "Flashfreeze"),(1, "Tireless Tracker"),(2, "Veil of Summer"),(2, "Wrenn and Six") }; } }
    }
}