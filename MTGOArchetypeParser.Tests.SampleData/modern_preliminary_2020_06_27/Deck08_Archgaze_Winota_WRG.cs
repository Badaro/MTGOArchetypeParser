...
{
    public class Deck08_Archgaze_Winota_WRG : ISampleDeck
    {
        ...
        public (int Count, string Name)[] Sideboard { get { return new (int Count, string Name)[] { (2, "Bonecrusher Giant"),(1, "Choke"),(1, "Collector Ouphe"),(1, "Damping Sphere"),(1, "Gaddock Teeg"),(1, "Klothys, God of Destiny"),(2, "Knight of Autumn"),(1, "Linvala, Keeper of Silence"),(1, "Obstinate Baloth"),(2, "Relic of Progenitus"),(1, "Thrun, the Last Troll"),(1, "Veil of Summer") }; } }
    }
}