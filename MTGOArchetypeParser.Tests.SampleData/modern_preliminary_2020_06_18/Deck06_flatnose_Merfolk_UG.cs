...
namespace MTGOArchetypeParser.Tests.SampleData.modern_preliminary_2020_06_18
{
    public class Deck06_flatnose_Merfolk_UG : ISampleDeck
    {
        ...
        public (int Count, string Name)[] Sideboard { get { return new (int Count, string Name)[] { (3, "Chalice of the Void"),(3, "Deprive"),(4, "Relic of Progenitus"),(3, "Tidebinder Mage"),(2, "Weather the Storm") }; } }
    }
}