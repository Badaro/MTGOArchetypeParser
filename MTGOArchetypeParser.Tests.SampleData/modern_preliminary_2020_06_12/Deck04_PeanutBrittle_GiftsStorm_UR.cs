...
namespace MTGOArchetypeParser.Tests.SampleData.modern_preliminary_2020_06_12
{
    public class Deck04_PeanutBrittle_GiftsStorm_UR : ISampleDeck
    {
        ...
        public (int Count, string Name)[] Sideboard { get { return new (int Count, string Name)[] { (2, "Abrade"),(1, "Aria of Flame"),(1, "Dismember"),(1, "Echoing Truth"),(3, "Empty the Warrens"),(2, "Lightning Bolt"),(2, "Mystical Dispute"),(2, "Pieces of the Puzzle"),(1, "Shattering Spree") }; } }
    }
}