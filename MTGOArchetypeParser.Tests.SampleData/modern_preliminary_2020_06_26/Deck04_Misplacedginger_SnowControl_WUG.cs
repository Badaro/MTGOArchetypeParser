...
{
    public class Deck04_Misplacedginger_SnowControl_WUG : ISampleDeck
    {
        ...
        public (int Count, string Name)[] Sideboard { get { return new (int Count, string Name)[] { (2, "Aether Gust"),(1, "Ashiok, Dream Render"),(2, "Celestial Purge"),(1, "Containment Priest"),(1, "Disdainful Stroke"),(1, "Monastery Mentor"),(1, "Mystical Dispute"),(2, "Rest in Peace"),(2, "Timely Reinforcements"),(2, "Veil of Summer") }; } }
    }
}