...
namespace MTGOArchetypeParser.Tests.SampleData.modern_preliminary_2020_06_11
{
    public class Deck03_ilmatagatto_Burn_WR : ISampleDeck
    {
        ...
        public (int Count, string Name)[] Sideboard { get { return new (int Count, string Name)[] { (1, "Skullcrack"),(1, "Exquisite Firecraft"),(3, "Kor Firewalker"),(3, "Path to Exile"),(3, "Rest in Peace"),(2, "Smash to Smithereens"),(2, "Wear // Tear") }; } }
    }
}