...
{
    public class Deck52_122pablo_JeskaiAscendancy_WURG_Jegantha : ISampleDeck
    {
        ...
        { 
            ...
            new SampleCard(1, "Nagging Thoughts"),
        ...
        { 
            ...
            new SampleCard(1, "Path to Exile"),
            new SampleCard(1, "Silence"),
            new SampleCard(1, "Veil of Summer"),
            new SampleCard(1, "Abrupt Decay"),
            new SampleCard(1, "Ceremonious Rejection"),
            new SampleCard(1, "Failure // Comply"),
