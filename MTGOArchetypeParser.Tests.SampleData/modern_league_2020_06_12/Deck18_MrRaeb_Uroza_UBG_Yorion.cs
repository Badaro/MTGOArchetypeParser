...
namespace MTGOArchetypeParser.Tests.SampleData.modern_league_2020_06_12
{
    public class Deck18_MrRaeb_Uroza_UBG_Yorion : ISampleDeck
    {
        ...
        public (int Count, string Name)[] Sideboard { get { return new (int Count, string Name)[] { (1, "Abrupt Decay"),(4, "Aether Gust"),(2, "Damping Sphere"),(2, "Dead of Winter"),(2, "Disdainful Stroke"),(3, "Veil of Summer"),(1, "Yorion, Sky Nomad") }; } }
    }
}