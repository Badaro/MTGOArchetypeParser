...
namespace MTGOArchetypeParser.Tests.SampleData.modern_preliminary_2020_06_20
{
    public class Deck15_signblindman_Ponza_RG : ISampleDeck
    {
        ...
        public (int Count, string Name)[] Sideboard { get { return new (int Count, string Name)[] { (2, "Boil"),(2, "Chandra, Torch of Defiance"),(2, "Cindervines"),(2, "Collector Ouphe"),(2, "Grafdigger's Cage"),(2, "Kitchen Finks"),(2, "Relic of Progenitus"),(1, "Weather the Storm") }; } }
    }
}