...
{
    public class Deck17_Micro_AdNauseam_WUB : ISampleDeck
    {
        ...
        public (int Count, string Name)[] Sideboard { get { return new (int Count, string Name)[] { (1, "Pact of Negation"),(1, "Bontu's Last Reckoning"),(1, "Echoing Truth"),(4, "Leyline of Sanctity"),(1, "Slaughter Pact"),(3, "Thoughtseize"),(4, "Veil of Summer") }; } }
    }
}