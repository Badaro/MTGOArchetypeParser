...
{
    public class Deck14_Manacymbal_KinnanUrza_URG_Yorion : ISampleDeck
    {
        ...
        public (int Count, string Name)[] Sideboard { get { return new (int Count, string Name)[] { (1, "Walking Ballista"),(1, "Damping Sphere"),(1, "Ensnaring Bridge"),(4, "Galvanic Blast"),(1, "Liquimetal Coating"),(1, "Skysovereign, Consul Flagship"),(1, "Sorcerous Spyglass"),(1, "Tormod's Crypt"),(3, "Veil of Summer"),(1, "Yorion, Sky Nomad") }; } }
    }
}