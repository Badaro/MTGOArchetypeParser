...
{
    public class Deck03_carlosalmeida_Ponza_RG : ISampleDeck
    {
        ...
        public (int Count, string Name)[] Sideboard { get { return new (int Count, string Name)[] { (1, "Pillage"),(2, "Anger of the Gods"),(2, "Choke"),(2, "Cindervines"),(2, "Collector Ouphe"),(2, "Grafdigger's Cage"),(2, "Obstinate Baloth"),(2, "Relic of Progenitus") }; } }
    }
}