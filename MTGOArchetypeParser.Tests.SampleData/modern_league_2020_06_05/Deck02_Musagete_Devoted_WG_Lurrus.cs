...
namespace MTGOArchetypeParser.Tests.SampleData.modern_league_2020_06_05
{
    public class Deck02_Musagete_Devoted_WG_Lurrus : ISampleDeck
    {
        ...
        public (int Count, string Name)[] Sideboard { get { return new (int Count, string Name)[] { (1, "Blossoming Defense"),(4, "Burrenton Forge-Tender"),(1, "Caustic Caterpillar"),(1, "Lurrus of the Dream Den"),(3, "Path to Exile"),(1, "Phyrexian Revoker"),(4, "Veil of Summer") }; } }
    }
}