...
{
    public class Deck22_BSKhercules_SnowControl_SultaiSnow_UBG : ISampleDeck
    {
        ...
        public (int Count, string Name)[] Sideboard { get { return new (int Count, string Name)[] { (1, "Abrupt Decay"),(1, "Dead of Winter"),(4, "Aether Gust"),(2, "Ashiok, Dream Render"),(1, "Assassin's Trophy"),(1, "Negate"),(2, "Shark Typhoon"),(2, "Surgical Extraction"),(1, "Veil of Summer") }; } }
    }
}