...
namespace MTGOArchetypeParser.Tests.SampleData.modern_league_2020_06_19
{
    public class Deck08_nolyfe_Prowess_R : ISampleDeck
    {
        ...
        public (int Count, string Name)[] Sideboard { get { return new (int Count, string Name)[] { (3, "Abrade"),(2, "Blood Moon"),(1, "Boil"),(1, "Dismember"),(4, "Dragon's Claw"),(1, "Kozilek's Return"),(3, "Soul-Guide Lantern") }; } }
    }
}