...
{
    public class Deck11_SonsoJF_Devoted_HeliodDevoted_WBG : ISampleDeck
    {
        ...
        public (int Count, string Name)[] Sideboard { get { return new (int Count, string Name)[] { (3, "Damping Sphere"),(1, "Knight of Autumn"),(3, "Kor Firewalker"),(3, "Path to Exile"),(3, "Thoughtseize"),(2, "Veil of Summer") }; } }
    }
}