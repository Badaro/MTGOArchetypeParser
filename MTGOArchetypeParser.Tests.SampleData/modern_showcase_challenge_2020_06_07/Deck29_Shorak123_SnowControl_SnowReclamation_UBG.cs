...
namespace MTGOArchetypeParser.Tests.SampleData.modern_showcase_challenge_2020_06_07
{
    public class Deck29_Shorak123_SnowControl_SnowReclamation_UBG : ISampleDeck
    {
        ...
        public (int Count, string Name)[] Sideboard { get { return new (int Count, string Name)[] { (3, "Aether Gust"),(2, "Ashiok, Dream Render"),(1, "Collective Brutality"),(3, "Dead of Winter"),(1, "Engineered Explosives"),(3, "Veil of Summer"),(2, "Weather the Storm") }; } }
    }
}