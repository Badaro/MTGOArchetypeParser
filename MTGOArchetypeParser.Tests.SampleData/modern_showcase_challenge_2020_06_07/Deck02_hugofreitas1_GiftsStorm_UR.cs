...
namespace MTGOArchetypeParser.Tests.SampleData.modern_showcase_challenge_2020_06_07
{
    public class Deck02_hugofreitas1_GiftsStorm_UR : ISampleDeck
    {
        ...
        public (int Count, string Name)[] Sideboard { get { return new (int Count, string Name)[] { (2, "Pieces of the Puzzle"),(1, "Abrade"),(3, "Aria of Flame"),(2, "Empty the Warrens"),(3, "Lightning Bolt"),(3, "Mystical Dispute"),(1, "Shattering Spree") }; } }
    }
}