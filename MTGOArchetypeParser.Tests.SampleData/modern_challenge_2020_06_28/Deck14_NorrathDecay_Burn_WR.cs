...
namespace MTGOArchetypeParser.Tests.SampleData.modern_challenge_2020_06_28
{
    public class Deck14_NorrathDecay_Burn_WR : ISampleDeck
    {
        ...
        public (int Count, string Name)[] Sideboard { get { return new (int Count, string Name)[] { (2, "Skullcrack"),(1, "Exquisite Firecraft"),(1, "Grafdigger's Cage"),(2, "Kor Firewalker"),(3, "Path to Exile"),(2, "Rest in Peace"),(3, "Smash to Smithereens"),(1, "Wear // Tear") }; } }
    }
}