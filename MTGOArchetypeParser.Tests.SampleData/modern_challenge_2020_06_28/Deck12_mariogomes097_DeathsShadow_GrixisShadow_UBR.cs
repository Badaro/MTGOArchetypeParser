...
namespace MTGOArchetypeParser.Tests.SampleData.modern_challenge_2020_06_28
{
    public class Deck12_mariogomes097_DeathsShadow_GrixisShadow_UBR : ISampleDeck
    {
        ...
        public (int Count, string Name)[] Sideboard { get { return new (int Count, string Name)[] { (1, "Bonecrusher Giant"),(2, "Cling to Dust"),(1, "Fatal Push"),(1, "Kolaghan's Command"),(1, "The Royal Scions"),(2, "Abrade"),(1, "Duress"),(1, "Grim Lavamancer"),(2, "Mana Leak"),(2, "Nihil Spellbomb"),(1, "Witch's Vengeance") }; } }
    }
}