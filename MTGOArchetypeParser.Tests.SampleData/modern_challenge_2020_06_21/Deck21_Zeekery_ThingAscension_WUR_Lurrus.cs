...
namespace MTGOArchetypeParser.Tests.SampleData.modern_challenge_2020_06_21
{
    public class Deck21_Zeekery_ThingAscension_WUR_Lurrus : ISampleDeck
    {
        ...
        public (int Count, string Name)[] Sideboard { get { return new (int Count, string Name)[] { (2, "Aether Gust"),(2, "Anger of the Gods"),(1, "Blessed Alliance"),(1, "Lurrus of the Dream Den"),(2, "Mystical Dispute"),(2, "Pillage"),(2, "Sprite Dragon"),(2, "Surgical Extraction"),(1, "Wear // Tear") }; } }
    }
}