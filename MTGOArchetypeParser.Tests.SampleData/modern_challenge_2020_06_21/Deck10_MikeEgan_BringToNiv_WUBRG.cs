...
{
    public class Deck10_MikeEgan_BringToNiv_WUBRG : ISampleDeck
    {
        ...
        { 
            ...
            new SampleCard(2, "Glittering Wish"),
        ...
        { 
            ...
            new SampleCard(2, "Deafening Clarion"),
            ...
            new SampleCard(1, "Slaughter Games") 
        };
    }
}