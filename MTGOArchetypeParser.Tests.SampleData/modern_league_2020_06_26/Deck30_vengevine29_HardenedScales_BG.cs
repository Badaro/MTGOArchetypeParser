...
{
    public class Deck30_vengevine29_HardenedScales_BG : ISampleDeck
    {
        ...
        public (int Count, string Name)[] Sideboard { get { return new (int Count, string Name)[] { (2, "Damping Sphere"),(3, "Fatal Push"),(1, "Lurrus of the Dream-Den"),(2, "Nature's Claim"),(1, "Nihil Spellbomb"),(2, "Thoughtseize"),(1, "Tormod's Crypt"),(1, "Torpor Orb"),(2, "Veil of Summer") }; } }
    }
}