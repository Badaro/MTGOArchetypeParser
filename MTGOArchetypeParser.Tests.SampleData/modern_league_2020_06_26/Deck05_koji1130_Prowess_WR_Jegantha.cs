...
{
    public class Deck05_koji1130_Prowess_WR_Jegantha : ISampleDeck
    {
        ...
        public (int Count, string Name)[] Sideboard { get { return new (int Count, string Name)[] { (2, "Blood Moon"),(2, "Grim Lavamancer"),(1, "Jegantha, the Wellspring"),(4, "Path to Exile"),(2, "Rest in Peace"),(4, "Wear // Tear") }; } }
    }
}