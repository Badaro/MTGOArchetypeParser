...
namespace MTGOArchetypeParser.Tests.SampleData.modern_challenge_2020_06_29
{
    public class Deck16_Janh_SnowControl_SultaiSnow_UBG : ISampleDeck
    {
        ...
        public (int Count, string Name)[] Sideboard { get { return new (int Count, string Name)[] { (1, "Abrupt Decay"),(1, "Dead of Winter"),(4, "Aether Gust"),(2, "Ashiok, Dream Render"),(1, "Assassin's Trophy"),(2, "Mystical Dispute"),(1, "Negate"),(2, "Nihil Spellbomb"),(1, "Veil of Summer") }; } }
    }
}