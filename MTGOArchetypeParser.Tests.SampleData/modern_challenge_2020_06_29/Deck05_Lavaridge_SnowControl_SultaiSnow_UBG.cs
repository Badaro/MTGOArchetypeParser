...
{
    public class Deck05_Lavaridge_SnowControl_SultaiSnow_UBG : ISampleDeck
    {
        ...
        public (int Count, string Name)[] Sideboard { get { return new (int Count, string Name)[] { (1, "Abrupt Decay"),(3, "Aether Gust"),(2, "Ashiok, Dream Render"),(1, "Assassin's Trophy"),(1, "Negate"),(3, "Plague Engineer"),(2, "Shark Typhoon"),(1, "Surgical Extraction"),(1, "Veil of Summer") }; } }
    }
}