...
{
    public class Deck25_D00mwake_PrimevalTitan_AmuletTitan_WURG : ISampleDeck
    {
        ...
        public (int Count, string Name)[] Sideboard { get { return new (int Count, string Name)[] { (1, "Abrade"),(2, "Aether Gust"),(2, "Dismember"),(2, "Firespout"),(1, "Pact of Negation"),(3, "Pithing Needle"),(1, "Reclamation Sage"),(3, "Tireless Tracker") }; } }
    }
}