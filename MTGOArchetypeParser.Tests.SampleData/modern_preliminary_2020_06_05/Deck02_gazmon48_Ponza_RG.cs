...
{
    public class Deck02_gazmon48_Ponza_RG : ISampleDeck
    {
        ...
        public (int Count, string Name)[] Sideboard { get { return new (int Count, string Name)[] { (2, "Anger of the Gods"),(1, "Boil"),(1, "Choke"),(2, "Cindervines"),(2, "Collector Ouphe"),(1, "Grafdigger's Cage"),(2, "Obstinate Baloth"),(2, "Relic of Progenitus"),(2, "Weather the Storm") }; } }
    }
}