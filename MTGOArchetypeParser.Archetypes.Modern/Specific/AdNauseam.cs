...
{
    public class AdNauseam : ArchetypeSpecific
    {
        public AdNauseam()
        {
            Conditions = new ArchetypeCondition[]
            {
                new ArchetypeCondition() { Type = ArchetypeConditionType.OneOrMoreInMainboard, Cards = new string[] { "Ad Nauseam", "Spoils of the Vault" } },
