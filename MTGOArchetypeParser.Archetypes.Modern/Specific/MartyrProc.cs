...
{
    public class MartyrProc : ArchetypeSpecific
    {
        public MartyrProc()
        {
            Conditions = new ArchetypeCondition[]
            {
                ...
                new ArchetypeCondition() { Type = ArchetypeConditionType.OneOrMoreInMainboard, Cards = new string[] { "Wrath of God", "Day of Judgment" } }
            };
        }
    }
}
