    ...
    public class ThopterCombo : ArchetypeSpecific
    {
        public ThopterCombo()
        {
            Conditions = new ArchetypeCondition[]
            {
                ...
                new ArchetypeCondition() { Type = ArchetypeConditionType.DoesNotContain, Cards = new string[] { "Urza, Lord High Artificer" } },
                new ArchetypeCondition() { Type = ArchetypeConditionType.DoesNotContain, Cards = new string[] { "Lantern of Insight" } },
            };
        }
    }
}
