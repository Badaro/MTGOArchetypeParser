    ...
    public class PrimevalTitan : ArchetypeSpecific
    {
        public PrimevalTitan()
        {
            Conditions = new ArchetypeCondition[]
            {
                ...
                new ArchetypeCondition() { Type = ArchetypeConditionType.OneOrMoreInMainboard, Cards = new string[] { "Summoner's Pact", "Hour of Promise", "Elvish Reclaimer", "Sakura-Tribe Elder", "Once Upon a Time" } },
    ...
    public class TitanShift : ArchetypeVariant
    {
        public TitanShift()
        {
            Conditions = new ArchetypeCondition[]
            {
                ...
                new ArchetypeCondition() { Type = ArchetypeConditionType.DoesNotContain, Cards = new string[] { "Elvish Reclaimer" } }
            };
        }
    }
