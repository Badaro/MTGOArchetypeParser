...
{
    public class NayaMidrange : ArchetypeSpecific
    {
        public NayaMidrange()
        {
            Conditions = new ArchetypeCondition[]
            {
                ...
                new ArchetypeCondition() { Type = ArchetypeConditionType.OneOrMoreInMainboard, Cards = new string[] { "Tarmogoyf", "Tireless Tracker" } }
            };
        }
    }
}
