...
{
    public class BantMidrange : ArchetypeSpecific
    {
        public BantMidrange()
        {
            Conditions = new ArchetypeCondition[]
            {
                ...
                new ArchetypeCondition() { Type = ArchetypeConditionType.TwoOrMoreInMainboard, Cards = new string[] { "Scavenging Ooze", "Geist of Saint Traft", "Stoneforge Mystic", "Knight of the Reliquary", "Karn, the Great Creator", "Rashmi, Eternities Crafter", "Prophet of Kruphix" } },
                new ArchetypeCondition() { Type = ArchetypeConditionType.DoesNotContain, Cards = new string[] { "Arcum's Astrolabe" } },
                new ArchetypeCondition() { Type = ArchetypeConditionType.DoesNotContain, Cards = new string[] { "Vizier of Remedies" } },
