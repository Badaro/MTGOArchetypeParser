...
* Download (or clone) the MTGO tournaments: https://github.com/Badaro/MTGODecklistParser
...
* ```meta=mymeta``` lets you filter to only include events in a specific meta.
