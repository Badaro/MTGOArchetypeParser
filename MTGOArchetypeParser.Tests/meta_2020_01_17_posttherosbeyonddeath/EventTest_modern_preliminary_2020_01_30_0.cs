...
{
    public class EventTest_modern_preliminary_2020_01_30_0 : EventTest
    {
        [Test]
        public void Deck01_Cherryxman_DiceFactoryTron_C()
        {
            Test(
                GetDeck("modern-preliminary-2020-01-30-0",0),
        ...
        {
            Test(
                GetDeck("modern-preliminary-2020-01-30-0",1),
                new PostTherosBeyondDeath(),
                ArchetypeColor.BRG,
        ...
        {
            Test(
                GetDeck("modern-preliminary-2020-01-30-0",2),
                new PostTherosBeyondDeath(),
                ArchetypeColor.R,
        ...
        {
            Test(
                GetDeck("modern-preliminary-2020-01-30-0",3),
                new PostTherosBeyondDeath(),
                ArchetypeColor.WUG,
                typeof(GenericBlink),
                null,
        ...
        {
            Test(
                GetDeck("modern-preliminary-2020-01-30-0",4),
                new PostTherosBeyondDeath(),
                ArchetypeColor.UR,
                typeof(FreeSpells),
        ...
        {
            Test(
                GetDeck("modern-preliminary-2020-01-30-0",5),
                new PostTherosBeyondDeath(),
                ArchetypeColor.UG,
                typeof(Uroza),
                null,
        ...
        {
            Test(
                GetDeck("modern-preliminary-2020-01-30-0",6),
                new PostTherosBeyondDeath(),
                ArchetypeColor.R,
                typeof(GenericProwess),
                null,
        ...
        {
            Test(
                GetDeck("modern-preliminary-2020-01-30-0",7),
                new PostTherosBeyondDeath(),
                ArchetypeColor.RG,
        ...
        {
            Test(
                GetDeck("modern-preliminary-2020-01-30-0",8),
                new PostTherosBeyondDeath(),
                ArchetypeColor.WUG,
        ...
        {
            Test(
                GetDeck("modern-preliminary-2020-01-30-0",9),
                new PostTherosBeyondDeath(),
                ArchetypeColor.R,
                typeof(GenericProwess),
                null,
        ...
        {
            Test(
                GetDeck("modern-preliminary-2020-01-30-0",10),
                new PostTherosBeyondDeath(),
                ArchetypeColor.UR,
                typeof(GenericControl),
                null,
        ...
        {
            Test(
                GetDeck("modern-preliminary-2020-01-30-0",11),
                new PostTherosBeyondDeath(),
                ArchetypeColor.UBR,
