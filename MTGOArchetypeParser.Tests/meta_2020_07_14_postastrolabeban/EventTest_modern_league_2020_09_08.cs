...
/*
#01 ProfessorAnthrax: Titan Shift (RG)
#02 Delpoctrol: KGC Tron (G)
#03 thedoc96: Uroza (WUG)
#04 The_GingerBrute: Hammer Time (WR, Lurrus)
...
#15 Voltzwagon: Gruul Midrange (RG)
#16 PieGonti: Elementals (WUBRG)
#17 Feyall: Jund Shadow (BRG)
#18 chaba_lol: Hammer Time (W)
#19 Artem_Kuhtin: White Devotion (W)
#20 muckymuck_dc5: Mono White Taxes (W)
#21 PieGonti: Snoop Goblins (BR)
#22 abijhavs: Mono Red Prowess (R)
#23 ANBKI: E Tron (C)
#24 urzatheplaneswalker: Bant Blink (WUG)
#25 Parrit: Mono White Taxes (W)
#26 Danielstallone: Burn (WR, Lurrus)
#27 Muldrotha7912: Grixis Shadow (UBR)
#28 kingoftheelves: Abzan Midrange (WBG)
...
#54 JohnWithaH: Jund Midrange (BRG)
