...
/*
#01 raven0904: G Tron (G)
#02 __BMJ__: Jund Shadow (BRG)
#03 cccaspar: White Devotion (W)
#04 Ritzulz: Ad Nauseam (WUB)
#05 Wooday: Infect (UG)
...
#12 Ganksyou: Azorius Control (WU)
#13 number1pwnr: Thalia Stompy (WR)
#14 forenmagra: Saheeli To Light (WUBRG)
...
#22 AlphaBlade: E Tron (C)
#23 Sebstrika: Mill (UB)
#24 Dwarshadow: Rakdos Prowess (BR, Lurrus)
#25 Toastxp: Azorius Control (WU)
#26 hermanomlg: Golgari Midrange (BG)
...
#45 ProfGOak: Thing Ascension (UR)
#46 Iceman76: Snoop Goblins (BR)
#47 Xurikk: Azorius Taxes (WU)
#48 Ceinos: Snoop Goblins (BRG)
#49 aqualog: Boros Prowess (WR, Lurrus)
#50 kingoftheelves: Abzan Midrange (WBG)
#51 gazurmah: Jund Midrange (BRG)
#52 Conor_man11: Eight Rack (B)
