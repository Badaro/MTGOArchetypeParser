...
#09 RodolfoSFD0: Titan Shift (RG)
#10 katobu: Heliod Combo (WG)
#11 sondrak: Naya Midrange (WRG)
#12 Asoen: Rakdos Midrange (BR)
#13 rodebo: U Tron (U)
...
#34 Metcalf23: Boros Taxes (WR, Yorion)
#35 SKAIANET: Esper Midrange (WUB)
...
#43 SvenSveeterSven: Izzet Control (UR)
#44 paucr5: Azorius Taxes (WU)
#45 Tar_Heels_82: Incinerator Burn (R)
#46 bershekprc10: Burn (WR)
#47 fradelrock: E Tron (C)
#48 manu_chao: Temur Control (URG)
#49 BlueLips: Bant Control (WUG)
#50 erose199423: Crabvine (UBG)
#51 10189011: Grixis Shadow (UBR)
#52 coert: Mono White Taxes (W)
#53 ScreenwriterNY: Azorius Taxes (WU)
#54 ripcalibretto13: Mono Red Prowess (R)
#55 Max315: Merfolk (U)
#56 bigjc00: Amulet Titan (URG)
...
#65 brainstorm39: Jeskai Control (WUR, Yorion)
#66 JimmySetzer: Snoop Goblins (BR)
#67 basebuilder: Ad Nauseam (WUB)
#68 Valyan: Abzan Midrange (WBG)
