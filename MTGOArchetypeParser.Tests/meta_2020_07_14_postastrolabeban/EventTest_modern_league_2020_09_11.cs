...
/*
#01 Kerrick_: EightRack (B)
#02 ragingpikey: Spirits (WU)
#03 AndersPovirk: Dredge (WBRG)
#04 junior97: RakdosMidrange (BR)
#05 Boin: Burn (WR, Lurrus)
#06 DarkKeeper: BantControl (WUG)
#07 POC: Infect (BG, Lurrus)
#08 rastaf: Bogles (WG, Lurrus)
#09 bobthyllama2: HeliodCombo (WG)
#10 Wolfie98: PrimevalTitan (URG)
#11 yPrincipe: ETron (C)
#12 ROBINMASK: UTron (U)
#13 AJV20: GrixisShadow (UBR)
#14 harukispecial: JeskaiControl (WUR)
#15 kokoko098: HeliodDevoted (WBG)
#16 Granham: KGCTron (G)
#17 Middeterminist: SimicReclamation (UG)
#18 MagikarpTheDeity: Infect (UG)
#19 Janh: SultaiControl (UBG)
#20 lawrencer12: JundMidrange (BRG)
#21 GingerAllanPoe: BorosProwess (WR, Lurrus)
#22 PuntThenWhine: KGCAmuletTitan (WUBRG)
#23 Irkus: AdNauseam (WUB)
#24 Mistakenn: AmuletTitan (URG)
#25 Parrit: MonoWhiteTaxes (W)
#26 sicsmoo: TemurControl (URG)
#27 _Stream: GrixisProwess (UBR)
#28 B1gDan: JundShadow (BRG, Lurrus)
#29 RAINkratos: HammerTime (W)
#30 anamika: Elementals (WUBRG)
#31 Albyz: TitanStompy (BRG)
#32 aspiringspike: AzoriusControl (WU)
#33 Pablo Figuero: Humans (WUBRG)
#34 GiovaniMF: JundShadow (BRG)
#35 Karlennon: TitanShift (RG)
#36 KIMCHIMAN: SnoopGoblins (BR)
#37 K4rl1991: HardenedScales (G)
#38 Toastxp: RakdosProwess (BR, Lurrus)
#39 SebastianStueckl: GruulMidrange (RG)
...
#47 Wuhsa: BringToNiv (WUBRG, Yorion)
#48 Trebz: AzoriusControl (WU)
#49 abijhavs: MonoRedProwess (R)
#50 davito: Merfolk (UG)
#51 komattaman: GruulMidrange (RG)
#52 Kurusu: KikiChord (WRG, Yorion)
#53 blastoids: Uroza (WUG)
#54 MHayashi: Merfolk (U)
#55 hermanomlg: GolgariMidrange (BG)
#56 Ivc: AzoriusControl (WU)
