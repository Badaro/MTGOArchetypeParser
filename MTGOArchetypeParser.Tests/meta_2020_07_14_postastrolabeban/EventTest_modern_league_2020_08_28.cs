...
/*
#01 BaronOfBacon: HammerTime (WR, Lurrus)
#02 B1gDan: JundShadow (BRG, Lurrus)
#03 Bordas99: GruulMidrange (RG)
#04 fede1: RakdosMidrange (BR)
#05 hugofreitas1: GiftsStorm (UR)
#06 tcgshin: TitanShift (RG)
#07 Bruno_Mineiro: JundMidrange (BRG)
#08 Esqpoe: EightRack (B)
#09 Srobmin: MonoRedProwess (R, Jegantha)
#10 Mordeka1ser: BringToNiv (WUBRG, Yorion)
#11 AngledLuffa: BantMidrange (WUG)
#12 DrSpectacles: Humans (WUBRG)
#13 Butakov: Yawgmoth (BG)
#14 Rosie54: SnoopGoblins (BR)
#15 kaktusowysmok: Merfolk (WU, Lurrus)
#16 DoctorQueller: Spirits (WU)
#17 junghans: HeliodCombo (WG)
#18 brainstorm39: JeskaiControl (WUR, Yorion)
#19 Leyline_of_the_Cat: BantSpirits (WUG)
#20 SeeFour: Lantern (UBRG)
#21 jaximus5: PrimevalTitan (URG)
#22 Ikashy: Dredge (BRG)
#23 Mistakenn: LivingEnd (BRG)
#24 MaliciousMac: BantControl (WUG)
#25 xzeroxx: IzzetProwess (UR)
#26 chris 0815: SnoopGoblins (BR)
#27 TheRedDawn2: Burn (WR)
#28 122pablo: JeskaiAscendancy (WURG, Jegantha)
#29 thedoc96: RakdosProwess (BR, Lurrus)
#30 NeryNeto: TemurDelver (URG)
#31 MlckyB: Bogles (WG)
#32 wowqqqa: KGCTron (G)
#33 sydneydude: BorosProwess (WR, Lurrus)
#34 PuntThenWhine: KGCAmuletTitan (WUBRG)
#35 Frozon: HardenedScales (G)
#36 603Leb: ValakutField (URG)
#37 Kumpanen: GrixisShadow (UBR)
#38 Diotima: MonoWhiteEldraziTaxes (W)
...
#46 Alcander: AzoriusControl (WU)
#47 kogamo: ValakutField (BRG)
#48 MrSeri: HeliodCombo (WG)
#49 ferrum0728: MarduShadow (WBR)
#50 yPrincipe: ETron (C)
#51 Ingalsarm: TemurReclamation (URG)
*/
