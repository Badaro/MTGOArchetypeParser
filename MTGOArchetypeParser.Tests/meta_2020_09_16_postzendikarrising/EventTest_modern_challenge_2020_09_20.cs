...
#06 Graven_Cairns: JundMidrange (BRG)
#07 Smdster: TemurControl (URG)
#08 JB2002: AzoriusControl (WU, Yorion)
...
#17 Magister_1993: AzoriusControl (WU)
#18 Erik157751: SultaiShadow (UBG)
#19 Rulleboren: Mill (UB, Lurrus)
#20 AstralPlane: RakdosProwess (BR, Lurrus)
#21 Bullwinkkle6705: WURGControl (WURG)
#22 Trid0n: Bogles (WG)
#23 SebastianStueckl: SultaiControl (UBG)
#24 kiko: JeskaiTaxes (WUR)
#25 quinniac: MonoRedProwess (R)
#26 pokerswizard: Mill (UB, Lurrus)
#27 Xwhale: Humans (WUBRG)
#28 Wiltron92: GrixisShadow (UBR)
#29 iaky91: Bogles (WG)
#30 eXavie: TemurControl (URG)
#31 Jokersrwild: GolgariMidrange (BG)
#32 TheBigMoke: SultaiReclamation (UBG)
*/
