...
/*
#01 JogandoPelado: Boros Land Destruction (WR)
#02 calexa: KGC Tron (G)
#03 xame3: Burn (WR)
...
#19 BSK_hercules: Reclaimer Titan (WURG)
#20 Schiapponetor: Heliod Combo (WG)
...
#29 iuriper: Ad Nauseam (WUB)
#30 CordoTwin: Shadow Prowess (BRG, Lurrus)
#31 TheMason: Golgari Midrange (BG)
#32 LakadMatataaag: Jeskai Control (WUR)
#33 ShzockChan: Cycling (WR)
#34 Kurusu: Kiki Chord (WRG, Yorion)
#35 ElPuerco: Grixis Shadow (UBR)
#36 Rakdos91: Hardened Scales (G)
#37 POC: Infect (BG, Lurrus)
#38 spiritmonger17: Gruul Midrange (RG)
#39 DoctorQueller: Bant Spirits (WUG)
#40 stayrospet: Omnath Saheeli (WURG, Jegantha)
#41 Somefellow: Esper Control (WUB)
...
#54 Ben_Illig: Gruul Midrange (RG)
#55 MagicalHack99: Bant Control (WUG, Yorion)
#56 win_and_in: Hammer Time (W, Lurrus)
#57 Selfeisek: Living End (BRG)
#58 Jetparrot: Snoop Goblins (BR)
#59 SpiderSpace: Inverter (UB)
#60 Luckyfinish: Rakdos Midrange (BR)
#61 futureshok: Dredge (BRG)
#62 TscheggschDePoegg: Bant Blink (WUG)
#63 mikro22: Mill (UB)
#64 FeeltheRush: Bant Midrange (WUG)
#65 Megalov: Titan Stompy (BRG, Gyruda)
#66 Tarrasque1: Elementals (WUBRG)
#67 ManPants: Jund Midrange (BRG)
*/
