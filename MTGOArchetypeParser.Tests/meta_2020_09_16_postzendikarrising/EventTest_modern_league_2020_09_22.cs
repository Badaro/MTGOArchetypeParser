...
/*
#01 lukystrike: Selenya Taxes (WG)
#02 DoctorQueller: Bant Spirits (WUG)
...
#22 BenMishania: Gruul Midrange (RG)
...
#30 renatoaraujo: KGC Tron (G)
#31 DFrank: WURG Control (WURG)
#32 Aphiladon: Hardened Scales (G)
#33 SpiderSpace: Mono White Taxes (W)
#34 HotBread: Naya Landfall (WRG, Lurrus)
#35 Kurusu: Kiki Chord (WRG, Yorion)
#36 jtl005: Heliod Combo (W, Lurrus)
...
#45 Gods_Shadow: Azorius Control (WU)
#46 XxquestionablyawesomexX: Bogles (WG, Lurrus)
#47 aarongulevich: Scapeshift (URG)
#48 Trebz: Azorius Control (WU)
#49 Roxas_13: Izzet Prowess (UR)
#50 POC: Infect (BG, Lurrus)
#51 kingoftheelves: Abzan Midrange (WBG)
#52 camr0n_1: Jeskai Control (WUR)
#53 kingoftheelves: Jund Midrange (BRG)
#54 kensportsfan: Mono Red Prowess (R)
#55 bobthyllama2: Heliod Combo (WG)
#56 TheTunnelingCat: E Tron (C)
#57 MagicDevil666: U Tron (U)
#58 Borjillamtg10: Rakdos Prowess (BR, Lurrus)
#59 Kuhb: Shadow Prowess (BRG)
#60 TuggaNaxos: Mill (WU, Lurrus)
#61 manu_chao: Sultai Control (UBG)
#62 wutang08: Jund Shadow (BRG)
