...
#05 Weasley: SultaiReclamation (UBG, Yorion)
...
#13 HouseOfManaMTG: AmuletTitan (UBRG)
#14 nahuel10: IzzetProwess (UR)
#15 Kurusu: KikiChord (WRG, Yorion)
#16 2jjm: Humans (WUBRG)
#17 Selfeisek: LivingEnd (BRG)
#18 ragnarboy: Infect (BG)
#19 CarnageSLV: GruulMidrange (RG)
#20 gyyby297: OopsAllSpells (WUBRG)
#21 Amplumnox: ShadowProwess (BR, Lurrus)
#22 bbotonline: WURGControl (WURG)
#23 The_nayr: NayaMidrange (WRG)
#24 BananaJim22: IzzetRestoreBalance (UR)
#25 Magric: Mill (UB)
#26 SpicyLeche: JundShadow (BRG)
#27 trollasceticftw: UrzaPrison (UR)
#28 TooManyCookes: JeskaiControl (WUR)
...
#36 Kenzaburo: AzoriusControl (WU)
#37 balltap: JeskaiBreach (WURG, Jegantha)
#38 Beicodegeia: GiftsStorm (UR)
#39 GrandpaBiceps: RakdosMidrange (BR)
#40 420PrayIt: SelesnyaEldrazi (WG, Jegantha)
#41 Jedermann: SnoopGoblins (BR)
#42 Hosaboy: AzoriusControl (WU)
...
#50 DoctorQueller: BantSpirits (WUG)
#51 BSK_hercules: SultaiControl (UBG)
#52 culkey: Yawgmoth (BG)
#53 ghostx02: Mill (UB, Lurrus)
#54 mashmalovsky: HammerTime (WR, Lurrus)
#55 Awesome7574: BantControl (WUG, Yorion)
#56 fuma-mtgcampinas: ETron (C)
*/
