...
/*
#01 kazuhiko: JeskaiControl (WUR)
#02 Kev_1414: Dredge (BRG)
#03 yunari-456: IzzetProwess (UR)
#04 DcNo: Humans (WUBRG)
#05 OnDutyMedic: SnoopGoblins (BR)
#06 wefaldbot: Inverter (UB)
#07 Tc1990: BantBlink (WUG)
#08 merfolkgod: IncineratorBurn (R)
#09 Brosterman: BantMidrange (WUG)
#10 Maccaciock: IzzetControl (UR)
#11 MartinezDP: SultaiControl (UBG, Yorion)
#12 Raptor_Nachos: MonoRedProwess (R, Jegantha)
#13 Gakihare: IzzetProwess (UR)
#14 fradev1988: AzoriusControl (WU)
#15 crazybaloth: Devoted (WG, Lurrus)
#16 Nis2a: HardenedScales (WG, Lurrus)
#17 lovepsy: HeliodDevoted (WG)
#18 Trellon: UTron (U)
#19 dbroncs1: GolgariMidrange (BG)
#20 DoctorQueller: Spirits (WU)
#21 Zxrogue: Yawgmoth (BG)
#22 StreexIT: BantSpirits (WUG)
#23 Parrit: MonoWhiteTaxes (W)
#24 Satelitbg123: IzzetControl (UR)
#25 _Makaveli: AzoriusControl (WU)
#26 Gubsly: EightRack (B)
#27 seasonofmists: AbzanEldraziTaxes (WBG)
#28 __Ghost__: Zombies (UB)
#29 AJOCHUM: WURGControl (WURG)
#30 CavalloGoloso: AzoriusControl (WU)
#31 FedeG: HeliodCombo (WG)
#32 axk2: Neobrand (UG)
#33 Antoine57437: WURGBlink (WURG)
#34 Selfeisek: LivingEnd (BRG)
#35 hugofreitas1: IzzetRestoreBalance (URG)
#36 klien7: OopsAllSpells (WUBRG)
#37 Salva1994: Merfolk (WU, Lurrus)
#38 TheDogFish: Merfolk (UG)
#39 IPlayBadDecks: JeskaiBreach (WURG, Jegantha)
#40 esseelle: BorosLandDestruction (WR)
#41 MadMaxErnst: ZombieShadow (BR, Lurrus)
#42 katoriarch123: BantControl (WUG)
#43 karavek: AmuletTitan (WUBRG)
#44 CyricCanela: GruulMidrange (RG)
#45 4pC-AlteC: Elves (G)
#46 aspiringspike: AzoriusControl (WU)
#47 Heiring: KGCTron (G)
#48 TuggaNaxos: Dredge (UBR)
#49 mala_grinja: Belcher (RG)
#50 Mulldrifter: ShadowProwess (BR, Lurrus)
#51 Rakdos91: HardenedScales (G)
...
#64 SaborDeSoledad: BorosLandDestruction (WR, Zirda)
#65 Sam_Lewin: BorosLandDestruction (WBR)
#66 pacoelflaco: Burn (WR)
#67 Hitokiri1984: RakdosMidrange (BR)
#68 Zanman: TakingTurns (UBG)
#69 Mateusf34: ETron (C)
*/
