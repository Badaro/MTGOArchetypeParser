...
/*
#01 NuBlkAu: RakdosShadow (BR)
#02 moyashi0904: WURGControl (WURG)
#03 buddha715: KGCTron (G)
#04 Rai_K: BushwhackerZoo (WRG)
#05 Loganinc: Scapeshift (UBRG)
#06 j_money10: ShadowProwess (BR, Lurrus)
#07 Tarrasque1: Elementals (WUBRG, Kaheera)
#08 Schnabulant: OopsAllSpells (WUBRG)
#09 RRozanski: PrimevalTitan (WURG)
#10 hsandi9: GrixisShadow (UBR, Lurrus)
#11 saccij92: JundMidrange (BRG)
#12 yuurari_yuko: HeliodCombo (WG)
#13 midnuzzles: MarduMidrange (WBR)
#14 Manuel_Danninger: MarduMidrange (WBR)
#15 JouNick: Humans (WUBRG)
#16 basebuilder: AdNauseam (WUB)
#17 MagicalHack99: KGCAmuletTitan (WUBRG)
#18 RyanWu: OrzhovMidrange (WB)
#19 GideonRavensword: Crabvine (UBG)
#20 Capiplaf95: Burn (WR)
#21 masakitaro: ETron (C)
#22 Yanley: SelenyaTaxes (WG)
#23 penach010: Smallpox (WBR)
#24 deathandcatmix: MonoWhiteTaxes (W, Lurrus)
#25 kurohiren: BringToNiv (WUBRG, Yorion)
#26 BoltTheBirds: GiftsStorm (UR)
...
#35 cntrlfreak: UBRGShadow (UBRG)
#36 StormGuyisme: OopsAllSpells (BRG)
#37 Sonkerz: Rogues (UB)
#38 TheDogFish: Merfolk (UG)
#39 tendercloud: HardenedScales (G)
#40 cccaspar: BantBlink (WUG)
#41 aooaaooa: Lantern (UB)
#42 Trid0n: BantMidrange (WUG)
#43 Nideon: Belcher (RG)
#44 wambocombo2020: UBRGControl (UBRG)
#45 SaborDeSoledad: NayaTaxes (WRG)
#46 ImmanuelKantrolGod: JeskaiControl (WUR)
#47 XxquestionablyawesomexX: Bogles (WG, Lurrus)
#48 kensportsfan: MonoRedProwess (R)
#49 keyan926: Burn (BR, Lurrus)
#50 kaktusowysmok: SnoopGoblins (BR)
#51 Polikasoll: IzzetProwess (UR)
#52 wingsfan24: NayaLandfall (WRG, Lurrus)
#53 thelastgod: SelenyaMidrange (WG)
#54 KrowNinja49: JeskaiControl (WUR)
