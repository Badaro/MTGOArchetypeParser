...
/*
#01 TuggaNaxos: ShadowProwess (BR, Lurrus)
#02 alexmw14: JundShadow (BRG)
#03 DaniMRebel: Spirits (WU)
#04 HouseOfManaMTG: AmuletTitan (UBRG)
#05 coert: HeliodCombo (WG)
#06 HamburgerJung: GolosTron (G, Jegantha)
#07 Chefen: Belcher (RG)
#08 ilsecco14: Neobrand (UG)
#09 N3to: GiftsStorm (UR)
#10 Gigy: NayaMidrange (WRG)
#11 gazmon48: OrzhovMidrange (WB)
#12 ZYURYO: WURGControl (WURG)
#13 Manuel_Danninger: MarduMidrange (WBR)
#14 audio336: ShadowProwess (BRG, Lurrus)
#15 Mateusf34: ETron (C)
#16 Jenara19: UBRGControl (UBRG)
#17 Lord_of_Puntlantis: IzzetRestoreBalance (URG)
#18 Jositoshekel: Burn (WR, Lurrus)
#19 Polikasoll: IzzetProwess (UR)
#20 GideonRavensword: Dredge (BRG)
#21 Beltan3: AdNauseam (WUB)
#22 Rinko: EnduringIdeal (WR)
#23 joetru: BringToNiv (WUBRG)
#24 futureshok: JundMidrange (BRG)
#25 Erik157751: ShadowProwess (BR, Lurrus)
#26 PhantasmalBear: Scapeshift (URG)
#27 MissTrigger: Bogles (WG)
#28 HotBread: ShadowProwess (BR, Lurrus)
#29 ziofrancone: Elementals (WR)
#30 Oscar_Franco: GrixisShadow (UBR)
#31 _Batutinha_: WURGControl (WURG)
#32 Bayesta_93: ShadowProwess (BR, Lurrus)
*/
