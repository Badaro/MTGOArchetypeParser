...
/*
#01 UrbanPope: RakdosProwess (BR, Lurrus)
#02 Foxantes: ETron (C)
#03 merliche: BantBlink (WUG, Yorion)
#04 BaDzIo: MonoRedProwess (R)
#05 katoriarch123: BantControl (WUG)
#06 DukeVitro: SultaiShadow (UBG)
#07 Delthar: Infect (BG)
#08 coert: HeliodCombo (WG)
#09 Chipsoss: GolgariMidrange (BG)
...
#17 wgary86: RakdosMidrange (BR)
#18 StreexIT: Spirits (WU)
#19 AJV20: Burn (BR, Lurrus)
#20 The_Demon_Inside07: Belcher (RG)
#21 Beicodegeia: GiftsStorm (UR)
#22 thefuryone987: ShadowProwess (WBR, Lurrus)
#23 fradev1988: IzzetRestoreBalance (URG)
#24 aspiringspike: AzoriusControl (WU)
...
#33 calexa: KGCTron (G)
#34 RearrangedAS: BantSpirits (WUG)
#35 chihoi: AmuletTitan (WUBRG)
#36 Antoine57437: AbzanCompany (WBRG)
#37 balltap: JeskaiBreach (WURG, Jegantha)
#38 Beicodegeia: GrixisControl (UBR)
#39 Wtnof: SaheeliCombo (WUR)
#40 Tiemuuu: IzzetControl (UR)
#41 wefald: Inverter (UB)
#42 aronfreyr1212: HardenedScales (G)
#43 bresett123: Humans (WUBRG)
#44 SeeFour: HammerTime (W)
#45 Gobern: BringToNiv (WUBRG, Yorion)
#46 DarkKeeper: WURGControl (WURG)
#47 moralmar: HeliodDevoted (WBG)
#48 MtGilligan: TemurControl (URG)
#49 TERROl2: JundShadow (BRG)
#50 PartyJaceBeleren04: TitanShift (RG)
#51 GideonRavensword: AdNauseam (WUB)
#52 Kenzaburo: AzoriusControl (WU)
#53 fishstza: BorosMidrange (WR)
#54 MartinezDP: BringToNiv (WUBRG, Yorion)
*/
