...
#08 PaChA94s: Ad Nauseam (WUB)
#09 Sonso JF: Heliod Devoted (WBG)
#10 cfilly4460: Golos Tron (G, Jegantha)
...
#23 ContraEgo: Thopter Urza (UBR)
#24 Blindside09: Hardened Scales (BG, Lurrus)
#25 il_matagatto: Burn (WR)
#26 DarkKeeper: WUBG Control (WUBG, Yorion)
#27 FuryGarruk: Emeria Titan (WU)
#28 MarmotaStore: Rakdos Prowess (BR, Lurrus)
#29 Blademaster777: Hammer Time (WR)
#30 Nagato_Boran: Jund Midrange (BRG)
#31 XOPYC: Mono White Taxes (W, Yorion)
#32 Traft: Infect (UG)
...
#52 TscheggschDePoegg: Sultai Control (UBG)
#53 PuNk_: Taking Turns (UR)
#54 Doomed_Necromancer: Abzan Midrange (WBG)
#55 willtheelf1: Gruul Midrange (RG)
