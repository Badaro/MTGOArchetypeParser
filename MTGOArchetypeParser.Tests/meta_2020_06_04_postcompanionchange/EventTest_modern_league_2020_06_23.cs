...
#16 robb93: Ad Nauseam (WUB)
#17 fenix4444: KGC Tron (G)
#18 YBLime: Thopter Urza (WUBR)
#19 aspiringspike: Grixis Lurrus (UBR)
#20 shine0905: Titan Stompy (BRG, Gyruda)
#21 MHayashi: Boros Prowess (WR, Jegantha)
#22 Granham: Jund Midrange (BRG)
#23 abombdiggity: Slivers (WUBRG)
#24 milikin: Gruul Midrange (RG)
#25 Jidden: Thopter Urza (WU)
#26 saccij92: Humans (WUBRG)
#27 Karstinen: Bogles (WG, Lurrus)
#28 KAKOLOLO: Bushwhacker Zoo (RG)
#29 Darthtaneon: Bushwhacker Zoo (RG)
...
#42 yutya: Bant Control (WUG, Yorion)
#43 _kg: Yawgmoth (BG)
#44 Metcalf23: Boros Taxes (WR)
#45 derramedefogo: Gifts Storm (UR)
#46 Zeekery: Thing Ascension (WUR, Lurrus)
#47 in5ano: Scapeshift (URG, Yorion)
#48 cjucjujp: Hardened Scales (BG, Lurrus)
#49 Pollu: Ad Nauseam (WUB)
#50 Gleiciano: Titan Shift (RG)
#51 SvenSveeterSven: Izzet Control (UR)
