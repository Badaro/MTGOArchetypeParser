...
/*
#01 nahuel10: Bant Control (WUG)
#02 Ennuixd: Mono Red Prowess (R)
#03 Lucabireskusku: Inverter (UB)
#04 Audemin: Humans (WUBRG)
#05 koji1130: Boros Prowess (WR, Jegantha)
#06 StreexIT: Spirits (WU)
#07 rojanosa: Orzhov Tokens (WB)
#08 haubidtran: Uroza (UBG, Yorion)
#09 esatheking: Boros Prowess (WR)
#10 yPrincipe: E Tron (C)
...
#22 Bunnykept: Jund Midrange (BRG)
...
#32 Trellon: U Tron (U)
#33 Netow: Dredge (BRG)
#34 Sonkerz: Izzet Control (UR)
#35 PieGonti: Kinnan Legends (URG, Yorion)
