...
#09 meanfannypack: Orzhov Shadow (WB)
#10 Doni_Dominaria: Rakdos Prowess (BR, Lurrus)
#11 AndersPovirk: Dredge (BRG)
#12 Polikasoll: Incinerator Burn (R)
#13 Parrit: Hardened Scales (G)
#14 kogamo: E Tron (C)
#15 Phyziks42: Naya Midrange (WRG)
#16 musasabi: Snoop Goblins (BR)
#17 Silence9428: Infect (UG)
#18 Do0mSwitch: Sultai Control (UBG)
...
#28 yPrincipe: Bant Control (WUG, Yorion)
#29 SvenSveeterSven: Izzet Control (UR)
#30 wefald: Inverter (UB)
#31 scvslayer: Scapeshift (URG, Yorion)
#32 MartinezDP: Bant Blink (WUG, Yorion)
#33 maear: Izzet Control (UR)
